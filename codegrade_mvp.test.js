  ...
  describe(`${label}`, () => {
    ...
    describe(`[D ${label}] Steps Counter,  Review how to set, manipulate, and display pieces of state, and handle user interaction.`, () => {
      test(`[D1 ${label}] Steps counter works correctly`, () => {
        expect(steps.textContent).toBe("You moved 0 time")
        fireEvent.click(up)
        fireEvent.click(up)
        fireEvent.click(left)
        expect(steps.textContent).toBe("You moved 2 time")
        fireEvent.click(right)
        fireEvent.click(right)
        expect(steps.textContent).toBe("You moved 4 time")
        fireEvent.click(down)
        fireEvent.click(down)
        fireEvent.click(down)
        expect(steps.textContent).toBe("You moved 6 time")
        fireEvent.click(left)
        fireEvent.click(left)
        fireEvent.click(left)
        expect(steps.textContent).toBe("You moved 8 time")
      })
